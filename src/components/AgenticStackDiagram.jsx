            ...
            <div style={{ flex: 1, display: 'flex', alignItems: 'center' }}>
                <div style={{ width: '100%', height: '100%', position: 'relative' }}>
                            ...
                            >
                                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                                    ...
                                    <div>
                                        ...
                                        <div style={{ fontSize: 'clamp(16px, 1.9vw, 18px)', color: 'var(--color-text-primary)', lineHeight: 1.35 }}>
                                            {s.subtitle}
                                        </div>
                                    </div>
                                </div>
                    ...
                    >
                        ...
                        <div style={{ color: 'var(--color-text-primary)', fontSize: 'clamp(16px, 1.9vw, 18px)', lineHeight: 1.6 }}>
                            {activeId === 'ingest'
