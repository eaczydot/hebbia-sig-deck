            ...
            <div className="split-40-60" style={{ flex: 1 }}>
                ...
                <div className="stagger-in active">
                    <div style={{ marginBottom: '30px' }}>
                        ...
                        <div style={{ fontSize: '20px', marginTop: '10px', color: 'var(--color-text-secondary)' }}>
                ...
                >
                    <GlassPanel style={{ height: '100%', padding: '24px' }}>
                        <div className="u-font-mono" style={{ fontSize: '14px', color: 'var(--color-text-tertiary)', marginBottom: '20px' }}>
