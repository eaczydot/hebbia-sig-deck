            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, minmax(0, 1fr))', gap: 'var(--layout-gap-xl)', alignItems: 'center' }}>
                ...
                <div>
                    ...
                    <div style={{ marginBottom: 'var(--spacing-2xl)' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px', color: '#64748B', fontSize: '16px' }}>
                        ...
                        <div style={{ width: '100%', height: 'clamp(34px, 4.5vh, 40px)', background: 'rgba(255,255,255,0.05)', borderRadius: '4px', display: 'flex' }}>
                            <div style={{ width: '40%', background: '#334155', borderRight: '1px solid #000', borderRadius: '4px 0 0 4px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '13px' }}>Search (6h)</div>
                            <div style={{ width: '40%', background: '#334155', borderRight: '1px solid #000', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '13px' }}>Extract (6h)</div>
                            <div style={{ width: '20%', background: '#475569', borderRadius: '0 4px 4px 0', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '13px' }}>Synthesize</div>
                        </div>
                    </div>
                    ...
                    >
                        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px', color: 'var(--color-agent-extraction-green)', fontSize: '16px', fontWeight: 600 }}>
                        ...
                        <div style={{ width: '100%', height: 'clamp(34px, 4.5vh, 40px)', background: 'rgba(255,255,255,0.05)', borderRadius: '4px', display: 'flex', position: 'relative' }}>
                            <div style={{ width: '15%', background: 'var(--color-agent-extraction-green)', borderRadius: '4px 0 0 4px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#000', fontSize: '13px', fontWeight: 700 }}>Auto</div>
                            <div style={{ width: '85%', background: '#334155', borderRadius: '0 4px 4px 0', display: 'flex', alignItems: 'center', paddingLeft: '16px', fontSize: '13px', color: '#94A3B8' }}>High-Value Strategic Analysis (Redeployed Time)</div>
