        ...
        <SlideContainer>
            ...
            >
                <div style={{ borderLeft: '2px solid var(--color-border-functional)', paddingLeft: 'var(--spacing-xl)' }}>
                    ...
                    <div className="u-font-mono" style={{ fontSize: 'clamp(13px, 1.4vw, 14px)', color: 'var(--color-text-secondary)' }}>Per 100 Documents</div>
                </div>
                <div style={{ borderLeft: '2px solid var(--color-border-functional)', paddingLeft: 'var(--spacing-xl)' }}>
                    <div className="big-num text-green" style={{ margin: 0 }}>100%</div>
                    <div className="u-font-mono" style={{ fontSize: 'clamp(13px, 1.4vw, 14px)', color: 'var(--color-text-secondary)' }}>Citation Coverage</div>
                </div>
                <div style={{ borderLeft: '2px solid var(--color-border-functional)', paddingLeft: 'var(--spacing-xl)' }}>
                    <div className="big-num text-purple" style={{ margin: 0 }}>Excel</div>
                    <div className="u-font-mono" style={{ fontSize: 'clamp(13px, 1.4vw, 14px)', color: 'var(--color-text-secondary)' }}>Native Export</div>
                </div>
            </motion.div>
        </SlideContainer>
    );
