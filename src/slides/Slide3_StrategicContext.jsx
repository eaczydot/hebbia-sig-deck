                    ...
                    <GlassPanel style={{
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 16 }}>
                            <div>
                                ...
                                <div style={{ fontSize: 'clamp(18px, 2.5vw, 24px)', color: 'var(--color-text-primary)', lineHeight: 1.25, maxWidth: 520 }}>
                        ...
                        <div style={{ marginTop: 'var(--spacing-xl)', borderTop: '1px solid var(--color-border-functional)', paddingTop: 'var(--spacing-xl)' }}>
                            ...
                            <div style={{ fontSize: 'clamp(18px, 2.2vw, 22px)', color: 'var(--color-text-primary)', lineHeight: 1.4 }}>
