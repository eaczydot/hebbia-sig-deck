    ...
    >
        <GlassPanel style={{ height: '100%', padding: 'clamp(16px, 2.2vw, 24px)', borderTop: `2px solid ${color}` }}>
            ...
            <ul style={{ padding: 0, margin: 0, listStyle: 'none' }}>
                {items.map((item, i) => (
                    <li key={i} style={{ display: 'flex', gap: 'var(--spacing-sm)', marginBottom: 'var(--spacing-md)', fontSize: 'clamp(14px, 1.5vw, 15px)', color: 'var(--color-text-secondary)', lineHeight: 1.5 }}>
