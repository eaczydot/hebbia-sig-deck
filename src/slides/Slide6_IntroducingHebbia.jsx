...
const FeatureBlock = ({ title, description, badge, align = 'left', delay }) => (
    ...
    >
        ...
        <p style={{ fontSize: '17px', color: 'var(--color-text-secondary)', lineHeight: 1.6, fontFamily: 'var(--font-primary)' }}>{description}</p>
    </motion.div>
);
                ...
                >
                    <GlassPanel style={{
                        ...
                        <div style={{
                            ...
                            <div style={{ color: 'var(--color-text-secondary)', fontFamily: 'var(--font-primary)', fontSize: '16px', lineHeight: 1.35 }}>
