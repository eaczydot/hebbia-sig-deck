    ...
    return (
        <SlideContainer>
            ...
            <div style={{ marginBottom: '40px' }}>
                ...
                <h2 className="text-title">Automated Diligence & Risk</h2>
            </div>
                ...
                >
                    <GlassPanel style={{ height: '100%', padding: '0', overflow: 'hidden' }}>
                        ...
                        <div style={{
                            ...
                            <div className="text-mono-sm" style={{ color: 'var(--color-text-tertiary)' }}>LEGAL DILIGENCE MODE</div>
                            <span className="pill green">ACTIVE</span>
                        </div>

                        <div style={{ padding: '24px' }}>
                            <div style={{ marginBottom: '20px', borderLeft: '2px solid var(--color-agent-reasoning-blue)', paddingLeft: '12px' }}>
                                <div className="text-mono-sm" style={{ color: 'var(--color-text-tertiary)', marginBottom: '4px' }}>CLAUSE TYPE</div>
                            ...
                            <div className="grid-2" style={{ marginTop: '20px' }}>
                                <div style={{ background: 'color-mix(in srgb, var(--color-text-primary) 2%, transparent)', padding: '15px', border: '1px solid var(--color-border-functional)' }}>
                                    <div className="text-mono-xs" style={{ color: 'var(--color-text-tertiary)', marginBottom: '8px' }}>STANDARD TEMPLATE</div>
                                ...
                                <div style={{ background: 'color-mix(in srgb, var(--color-agent-citation-orange) 5%, transparent)', padding: '15px', border: '1px solid var(--color-agent-citation-orange)' }}>
                                    <div className="text-mono-xs" style={{ color: 'var(--color-agent-citation-orange)', marginBottom: '8px' }}>⚠ VARIANCE DETECTED</div>
                                    <div className="text-caption" style={{ lineHeight: 1.5 }}>
